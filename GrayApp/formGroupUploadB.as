package cuatroPlumasUI.GrayApp {
	import pragmaTico.CRCarrosLeads.Web.Admin.Publicidad.NewFormModal;
	 ...
	 */
	public class formGroupUploadB extends Sprite {
		...
		public function formGroupUploadB(url:String,cont:NewFormModal):void {
			this.container = cont;
