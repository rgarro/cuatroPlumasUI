package cuatroPlumasUI.GrayApp {
	 ...
	 */
	public class PaginatorPrevBtn extends Sprite {
		...
		public function PaginatorPrevBtn(offSetInt:Number,limitInt:Number):void {
			this.offSet = offSetInt;
			this.limit = limitInt;
			this.assets = new Assets();
			this.bg = new Bitmap(assets.paginacionBackBgData);
		...
		protected function evtClick(e:MouseEvent):void{
			this.bg.bitmapData = this.assets.paginacionBackBgOffData;
			this.clickSound.play();
		}
		
		protected function outEvt(e:MouseEvent):void{
			this.bg.bitmapData = this.assets.paginacionBackBgData;
		}
		
		protected function overEvt(e:MouseEvent):void{
			this.bg.bitmapData = this.assets.paginacionBackBgOverData;
		}
	}
}